...
<section id="portfolio" class="container main">
    <ul class="gallery col-4">
        ...
        <li>
            <div class="preview">
                <img alt=" " src="../images/sample/gallery/img9.png">
                <div class="overlay">
                </div>
                <div class="links">
            ...
            <div id="modal-1" class="modal hide fade">
                ...
                <div class="modal-body">
                    <img src="../images/sample/gallery/img1.jpg" alt=" " width="100%" style="max-height:400px">
                </div>
            </div>
        </li>
        <!--/Item 1-->
        ...
        <li>
            ...
            <div id="modal-1" class="modal hide fade">
                <a class="close-modal" href="javascript:;" data-dismiss="modal" aria-hidden="true"><i class="icon-remove"></i></a>
                <div class="modal-body">
                    <img src="../images/sample/gallery/img2.jpg" alt=" " width="100%" style="max-height:400px">
                </div>
            </div>
        </li>
        <!--/Item 2-->
